    ...
    public class TabControl : Container
    {
        ...
        protected override void DrawControl(Rectangle rect)
        {
            ...
            if (tabPages.Count > 0)
            {
                ...
                for (int i = 0; i < tabPages.Count; i++)
                {
                    SpriteFont font = l2.Text.Font.Resource.XnaSpriteFont;
                ...
                for (int i = tabPages.Count - 1; i >= 0; i--)
                {
                    ...
                    if (i != selectedIndex)
                    {
                        ...
                        Renderer.DrawString(l2.Text.Font.Resource.XnaSpriteFont, tabPages[i].Text, sx, lc, l2.Text.Alignment);
                    }
                }
                ...
                Renderer.DrawString(l2.Text.Font.Resource.XnaSpriteFont, tabPages[selectedIndex].Text, si, l2.Text.Colors.Focused, l2.Text.Alignment, l2.Text.OffsetX, l2.Text.OffsetY, false);
            }
        } // DrawControl
