...
namespace XNAFinalEngine.Graphics
{
    ...
    /// Important: Only dispose the texture created without the content manager.
	/// </summary>
    public class Texture : Disposable
    {
		...
		/// </summary>
        /// <param name="_textureFilename">Set filename, must be relative and be a valid file in the textures directory.</param>
