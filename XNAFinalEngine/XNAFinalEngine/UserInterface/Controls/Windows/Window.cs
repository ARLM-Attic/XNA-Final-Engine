...
namespace XNAFinalEngine.UI
{
    ...
    public class Window : ModalContainer
    {
        ...
        public Window()
        {
            ...
            {
                SkinControlInformation = new SkinControl(UIManager.Skin.Controls[skinButton]),
                Detached = true,
                CanFocus = false,
                Text = null,
            };
        ...
        {
            base.InitSkin();
            SkinControlInformation = new SkinControl(UIManager.Skin.Controls[skinWindow]);
            AdjustMargins();
            ...
            CheckLayer(UIManager.Skin.Controls[skinButton], layerButton);
            CheckLayer(UIManager.Skin.Controls[skinShadow], layerShadow);
        } // InitSkin
        ...
        {
            buttonClose.SkinControlInformation = new SkinControl(UIManager.Skin.Controls[skinButton]);
        ...
        internal override void Render()
        {
            ...
            if (Visible && Shadow)
            {
                SkinControl skinControlShadow = UIManager.Skin.Controls[skinShadow];
        ...
        protected override void DrawControl(Rectangle rect)
        {
            ...
            SpriteFont font = skinLayerFrameTop.Text.Font.Resource;
            Color color;

            if ((Focused || (UIManager.FocusedControl != null && UIManager.FocusedControl.Root == Root)) && ControlState != ControlState.Disabled)
            {
        ...
        {
            Left = (EngineManager.Width / 2) - (Width / 2);
            Top = (EngineManager.Height - Height) / 2;
        } // Center
