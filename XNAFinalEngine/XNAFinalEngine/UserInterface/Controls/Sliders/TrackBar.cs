...
namespace XNAFinalEngine.UI
{
    ...
    public class TrackBar : Control
    {
        ...
        {
            base.Init();
            buttonSlider.SkinControlInformation = new SkinControl(UIManager.Skin.Controls["TrackBar.Button"]);
        ...
        {
            base.InitSkin();
            SkinControlInformation = new SkinControl(UIManager.Skin.Controls["TrackBar"]);
        } // InitSkin
        ...
        private void RecalculateParameters()
        {
            if (buttonSlider != null)
            {
                ...
                {
                    buttonSlider.Glyph = new Glyph(UIManager.Skin.Images["Shared.Glyph"].Texture) { SizeMode = SizeMode.Centered };
                }
                else
                {
        ...
        protected override void OnMouseDown(MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButton.Left)
            {
                ...
                XNAFinalEngine.Input.Mouse.MouseState = new MouseState();
                UIManager.Input.Update();
            }
        } // OnMousePress
