...
namespace XNAFinalEngine.UI
{
    ...
    public class Button : ButtonBase
    {
        ...
        {
            base.InitSkin();
            SkinControlInformation = new SkinControl(UIManager.Skin.Controls["Button"]);
        } // InitSkin
        ...
        protected override void DrawControl(Rectangle rect)
        {
            ...
            if (glyph != null)
            {
                ...
                Rectangle r = new Rectangle(rect.Left + cont.Left + (rect.Width - cont.Horizontal) / 2 - glyph.SourceRectangle.Width / 2,
                                            rect.Top + cont.Top,
