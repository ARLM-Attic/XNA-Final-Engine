...
namespace XNAFinalEngine.UI
{
    ...
    public class ComboBox : TextBox
    {
        ...
        public ComboBox()
        {
            ...
            {
                SkinControlInformation = new SkinControl(UIManager.Skin.Controls["ComboBox.Button"]),
                CanFocus = false
            };
        ...
        protected internal override void Init()
        {
            ...
            listCombo.SkinControlInformation = new SkinControl(UIManager.Skin.Controls["ComboBox.ListBox"]);
            buttonDown.Glyph = new Glyph(UIManager.Skin.Images["Shared.ArrowDown"].Texture)
            {
                Color =
                    UIManager.Skin.Controls["ComboBox.Button"].Layers["Control"].Text.Colors.
                    Enabled,
        ...
        {
            base.InitSkin();
            SkinControlInformation = new SkinControl(UIManager.Skin.Controls["ComboBox"]);
            AdjustMargins();
        ...
        private void ButtonDownClick(object sender, EventArgs e)
        {
            if (items != null && items.Count > 0)
            {
                ...
                if (listCombo.ControlTopAbsoluteCoordinate + listCombo.Height > EngineManager.Height)
                {
