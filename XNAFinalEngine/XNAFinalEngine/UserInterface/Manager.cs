...
namespace XNAFinalEngine.UI
{
    ...
    public static class UIManager
    {
        ...
        /// </summary>
        private static RenderToTexture renderTarget;
        ...
        /// </summary>
        public static float GlobalDepth { get; set; }
        ...
        /// </summary>
        public static bool UseGuide { get; set; }
        ...
        public static void InitUIManager()
        {
            ...
            EngineManager.GraphicsManager.PreparingDeviceSettings += PrepareGraphicsDevice;
            ...
            renderTarget = new RenderToTexture(RenderToTexture.SizeType.FullScreen, false, false);
        ...
        private static void FormClosing(object sender, FormClosingEventArgs e)
        {
            ...
            {   
                EngineManager.IsApplicationActive = true;
        ...
        private static void PrepareGraphicsDevice(object sender, PreparingDeviceSettingsEventArgs e)
        {
            ...
            {
                SetMaxSize(control, EngineManager.Width, EngineManager.Height);
            }
        ...
        public static void SetSkin(string skinFilename)
        {
            ...
            foreach (Control c in Control.controlList)
            {
                c.InitSkin();
            }
        ...
        public static void Update()
        {
            ...
            {
                throw new Exception("User Interface Update Operation failed.");
            }
        } // Update
        ...
        public static void EndDraw()
        {
            Renderer.Begin(Renderer.BlendingMode.Transparent);
                Renderer.Draw(renderTarget.XnaTexture, new Rectangle(0, 0, EngineManager.Width, EngineManager.Height), Color.White);
            Renderer.End();
        } // EndDraw
