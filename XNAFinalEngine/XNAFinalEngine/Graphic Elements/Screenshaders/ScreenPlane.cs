...
namespace XNAFinalEngine.GraphicElements
{
    ...
    public static class ScreenPlane
    {
        ...
        private class VertexBufferScreenPlane
        {
            ...
            /// </summary>
            private VertexBuffer vertexBufferScreen;
            ...
            internal VertexBufferScreenPlane()
            {
                ...
                {
                    new VertexPositionTexture(new Vector3(-1.0f, -1.0f, 0.5f), new Vector2(0, 1)),
                    new VertexPositionTexture(new Vector3(-1.0f, 1.0f, 0.5f),  new Vector2(0, 0)),
                    new VertexPositionTexture(new Vector3(1.0f, -1.0f, 0.5f),  new Vector2(1, 1)),
                    new VertexPositionTexture(new Vector3(1.0f, 1.0f, 0.5f),   new Vector2(1, 0)),
                };
        ...
        /// Vb screen instance
        /// </summary>
        static VertexBufferScreenPlane vertexBufferScreenPlane = null;
