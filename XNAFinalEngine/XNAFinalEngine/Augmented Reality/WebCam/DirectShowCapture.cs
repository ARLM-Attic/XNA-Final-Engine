...
{
    /// <summary>
    /// Clase auxiliar que maneja la captura de la camara web a "bajo" nivel.
    /// </summary>
    internal class DirectShowCapture : ISampleGrabberCB, IDisposable
    {
        ...
        /// <summary>
        /// Los cuadros por segundo a los que se calculara.
        /// </summary>
        private int fps;
        ...
        /// </summary>
        public DirectShowCapture(int iDeviceNum, int iWidth, int iHeight, short iBPP, int _fps, Control hControl, Guid mediaSubType)
        {
            DsDevice [] capDevices;
        ...
        public IntPtr Click()
        {
            ...
            try
            {
                ...
                // Start waiting
                if ( ! m_PictureReady.WaitOne(900, false) ) 
                {   
        ...
        private void SetConfigParms(IPin pStill, int iWidth, int iHeight, short iBPP)
        {
            ...
            try
            {
                ...
                v.AvgTimePerFrame = (long)(10000000 / (float)fps);//444444;
